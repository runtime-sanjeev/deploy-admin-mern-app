                            ...
                            <input
                                ...
                                <div className="flex flex-col items-center">
                                      {previewImage ? (
                                        ...
                                        <img
                                          src={`https://deploy-admin-mern-app-1.vercel.app/temp/${selectedEmployee.professionalDetails.photo}`} // Fallback to existing photo
                                          alt="Preview"
                                          style={{ width: "200px" }}
                                          className="w-32 h-32 object-cover rounded-md border border-gray-200"
                                        />
                                    ...
                                    {resumeAvailable && selectedEmployee?.professionalDetails?.resume ? (
                                      <>
                                        ...
                                        <button
                                          ...
                                          onClick={() =>
                                            window.open(
                                              `https://deploy-admin-mern-app-1.vercel.app/temp/${selectedEmployee.professionalDetails.resume}`,
                                              '_blank'
                                            )
                                          }
