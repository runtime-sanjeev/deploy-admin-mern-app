                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    cell: (row) => (
                      <button
                        type="button"
                        onClick={() => window.open(`https://deploy-admin-mern-app-1.vercel.app/public/photo/${row.professionalDetails.photo}`, '_blank')}
                        className="focus:outline-none text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5"
                      >
                        View Image
                      </button>
                            ...
                            <input
                                ...
                                <div className="flex flex-col items-center">
                                      {previewImage ? (
                                        ...
                                        <img
                                          src={`https://deploy-admin-mern-app-1.vercel.app/public/photo/${selectedEmployee.professionalDetails.photo}`} // Fallback to existing photo
                                          alt="Preview"
                                          style={{ width: "200px" }}
                                          className="w-32 h-32 object-cover rounded-md border border-gray-200"
                                        />
                                    ...
                                    {resumeAvailable && selectedEmployee?.professionalDetails?.resume ? (
                                      <>
                                        ...
                                        <button
                                          ...
                                          onClick={() =>
                                            window.open(
                                              `https://deploy-admin-mern-app-1.vercel.app/public/resume/${selectedEmployee.professionalDetails.resume}`,
                                              '_blank'
                                            )
                                          }
